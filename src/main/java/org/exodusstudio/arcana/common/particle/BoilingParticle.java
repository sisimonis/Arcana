...
public class BoilingParticle extends TextureSheetParticle {
    ...
    public BoilingParticle(ClientLevel level, double x, double y, double z,SpriteSet spriteSet, double xSpeed, double ySpeed, double zSpeed) {
    ...
    public static class Provider implements ParticleProvider<SimpleParticleType> {
        ...
        public @Nullable Particle createParticle(SimpleParticleType simpleParticleType, ClientLevel clientLevel,
            ...
            return new BoilingParticle(clientLevel, pX, pY, pZ, this.spriteSet, pXSPeed, pYSpeed, pZSpeed);
        }
    }
